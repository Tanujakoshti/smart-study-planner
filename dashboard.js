...
function saveDataToStorage() {
  ...
  localStorage.setItem('sf_goals', JSON.stringify(state.goals));
  localStorage.setItem('sf_focus_logs', JSON.stringify(state.focusLogs));
  localStorage.setItem('sf_streak', JSON.stringify(state.streak));
  localStorage.setItem('sf_achievements', JSON.stringify(state.achievements));
}
